...
void UnoProcessor::setCurrentProgram(int index)
{
	juce::ignoreUnused(index);
}

const juce::String UnoProcessor::getProgramName(int index)
{
	juce::ignoreUnused(index);
	return {};
}

void UnoProcessor::changeProgramName(int index, const juce::String& newName)
{
